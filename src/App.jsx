...
/* ─────────────── DATA ─────────────── */
const CATEGORIES = ["Todos", "Collares", "Ropa", "Juguetes", "Camas", "Accesorios"];
        ...
        <div style={styles.featuredScroll}>
          {featured.map((p) => (
            <div key={p.id} style={styles.featuredCard} onClick={() => setSelectedProduct(p)}>
              <div style={styles.featuredEmoji}>{p.image}</div>
          ...
          <div style={styles.productGrid}>
            {filteredProducts.map((p) => (
              <div key={p.id} style={styles.productCard} onClick={() => setSelectedProduct(p)}>
                <div style={styles.productEmoji}>{p.image}</div>
    ...
    <div style={styles.detailPage}>
      ...
      <div style={styles.detailCard}>
        <div style={styles.detailEmojiBox}>
          <span style={styles.detailEmoji}>{product.image}</span>
        </div>
    ...
    <div style={styles.adminPage}>
      ...
      {showAdd && (
        <div style={styles.formCard}>
          ...
          <input style={styles.input} placeholder="Nombre" value={newProduct.name} onChange={(e) => setNewProduct({ ...newProduct, name: e.target.value })} />
          <div style={{ display: "flex", gap: 10 }}>
            <input style={{ ...styles.input, flex: 1 }} placeholder="Precio" type="number" value={newProduct.price} onChange={(e) => setNewProduct({ ...newProduct, price: e.target.value })} />
          ...
          <input style={styles.input} placeholder="Emoji (ej: 🐾)" value={newProduct.image} onChange={(e) => setNewProduct({ ...newProduct, image: e.target.value })} />
          ...
          <input style={styles.input} placeholder="Descripción" value={newProduct.desc} onChange={(e) => setNewProduct({ ...newProduct, desc: e.target.value })} />
          ...
          <div key={p.id} style={styles.adminRow}>
            {editingId === p.id ? (
              <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 8 }}>
                <input style={styles.inputSm} value={editForm.name} onChange={(e) => setEditForm({ ...editForm, name: e.target.value })} />
                <div style={{ display: "flex", gap: 8 }}>
                  <input style={{ ...styles.inputSm, width: 80 }} type="number" value={editForm.price} onChange={(e) => setEditForm({ ...editForm, price: e.target.value })} />
                  <input style={{ ...styles.inputSm, width: 60 }} type="number" value={editForm.stock} onChange={(e) => setEditForm({ ...editForm, stock: e.target.value })} />
